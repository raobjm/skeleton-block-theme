 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme Skeleton Block Theme
...
add_action( 'tgmpa_register', 'skeleton_block_theme_register_required_plugins' );
 ...
 */
function skeleton_block_theme_register_required_plugins() {
	/*
	 ...
	 */
	$config = array(
		'id'           => 'theme-text-domain',                 // Unique ID for hashing notices for multiple instances of TGMPA.
