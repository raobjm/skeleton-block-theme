...
<h2 class="has-text-align-center has-x-large-font-size"><?php esc_html_e( 'Page not found', 'starter-basic' ); ?></h2>
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p><?php esc_html_e( 'It looks like nothing was found at this location. Maybe try a search?', 'starter-basic' ); ?></p>
<!-- /wp:paragraph -->
...
<h2 class="has-text-align-left"><?php esc_html_e( 'Latest posts', 'starter-basic' ); ?></h2>
<!-- /wp:heading -->
